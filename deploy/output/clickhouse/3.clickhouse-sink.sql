...
CREATE TABLE if not exists shard.user_dep ON CLUSTER 'shard2-repl1'
(
...
CREATE TABLE if not exists shard.files ON CLUSTER 'shard2-repl1'
(
...
CREATE TABLE if not exists shard.dws_collaboration_7d_statistic_by_department_daily ON CLUSTER 'shard2-repl1'
(
...
CREATE TABLE if not exists shard.dws_collaboration_7d_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `add_collaborations` Nullable(Int64) COMMENT '添加协作次数（按添加协作操作的动作次数算）',
...
CREATE TABLE if not exists shard.dws_collaboration_7d_statistic_by_member_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
...
-- 最近30天协作 （成员级别）
-- drop table if exists shard.dws_collaboration_30d_statistic_by_member_daily ON CLUSTER 'shard2-repl1';
CREATE TABLE if not exists shard.dws_collaboration_30d_statistic_by_member_daily ON CLUSTER 'shard2-repl1'
(
...
-- drop table if exists all.dws_collaboration_30d_statistic_by_member_daily ON CLUSTER 'shard2-repl1';
CREATE TABLE if not exists all.dws_collaboration_30d_statistic_by_member_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近30天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `user_id` Nullable(String) COMMENT '企业ID',
    ...
    `file_views` Nullable(Int64) COMMENT '浏览文件数',
    `create_files` Nullable(Int64) COMMENT '创建文件数'
) ENGINE = Distributed('shard2-repl1', 'shard', 'dws_collaboration_30d_statistic_by_member_daily', rand());

-- 最近7天企业活跃用户统计 （全局级别）
-- drop table if exists shard.dws_enterprise_7d_user_statistic_by_global_daily ON CLUSTER 'shard2-repl1';
CREATE TABLE if not exists shard.dws_enterprise_7d_user_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
...
CREATE TABLE if not exists shard.dws_enterprise_td_usage_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
...
CREATE TABLE if not exists shard.dws_file_1d_hot_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
...
CREATE TABLE if not exists shard.dws_file_7d_hot_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期',
    `team_id` Nullable(String) COMMENT '企业ID',
    `guid` Nullable(String) COMMENT '文件ID',
...
CREATE TABLE if not exists shard.dws_file_7d_product_statistic_by_department_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `department_id` Nullable(String) COMMENT '部门ID',
...
CREATE TABLE if not exists shard.dws_file_7d_product_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `create_objs` Nullable(Int64) COMMENT '新建总文件数',
...
CREATE TABLE if not exists shard.dws_file_7d_product_statistic_by_member_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `user_id` Nullable(String) COMMENT '用户ID',
...
CREATE TABLE if not exists shard.dws_file_7d_statistic_by_department_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `department_id` Nullable(String) COMMENT '部门ID',
...
CREATE TABLE if not exists shard.dws_file_7d_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `create_files` Nullable(Int64) COMMENT '新建文件数（不包括文件夹和空间）',
...
CREATE TABLE if not exists shard.dws_file_7d_statistic_by_member_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
...
CREATE TABLE if not exists shard.dws_space_1d_updated_statistic_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期',
    `team_id` Nullable(String) COMMENT '企业ID',
    `guid` Nullable(String) COMMENT '文件ID',
...
-- drop view if exists all.dws_enterprise_7d_ative_user_statistic_by_global_daily_view on cluster 'shard2-repl1';
create view  if not exists all.dws_enterprise_7d_active_user_statistic_by_global_daily_view on cluster 'shard2-repl1' as select
    ldate,
    team_id,
    user_id,
...
-- 最近30天活跃成员（全局级别）
-- 公式：活跃分 = 浏览数*1 + 生产数（即新建文件数）*10 + 协作行为（包括添加协作、公开分享、评论次数、@人次数）*5
-- drop view if exists all.dws_enterprise_30d_active_user_statistic_by_global_daily_view on cluster 'shard2-repl1';
create view  if not exists all.dws_enterprise_30d_active_user_statistic_by_global_daily_view on cluster 'shard2-repl1' as select
    ldate,
    team_id,
    user_id,
    (file_views * 1 + create_files * 10 + (add_collaborations + public_shares + comments + use_ats) * 5)  as active_score
...
create view if not exists all.dws_enterprise_td_save_time_statistic_by_global_daily_view on cluster 'shard2-repl1' as select
    ldate,
    team_id,
...
create view  if not exists all.dws_enterprise_td_auto_saves_statistic_by_global_daily_view on cluster 'shard2-repl1' as select
    ldate,
    team_id,
...
CREATE TABLE if not exists shard.dws_creation_1d_download_by_global_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期',
    `team_id` Nullable(String) COMMENT '企业ID',
    `create_objs` Nullable(Int64) COMMENT '新建总文件数',
...
CREATE TABLE if not exists shard.dws_usage_1d_download_by_member_daily ON CLUSTER 'shard2-repl1'
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` Nullable(String) COMMENT '企业ID',
    `department_id` Nullable(String) COMMENT '部门ID',
