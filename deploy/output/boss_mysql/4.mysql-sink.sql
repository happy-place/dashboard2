...
CREATE TABLE if not exists boss.dws_collaboration_7d_statistic_by_global_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `add_collaborations` int(6) COMMENT '添加协作次数（按添加协作操作的动作次数算）',
...
CREATE TABLE if not exists boss.dws_collaboration_7d_statistic_by_member_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
...
CREATE TABLE if not exists boss.dws_collaboration_30d_statistic_by_member_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `user_id` varchar(50) COMMENT '成员ID',
...
CREATE TABLE if not exists boss.dws_file_1d_hot_statistic_by_global_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
...
CREATE TABLE if not exists boss.dws_file_7d_hot_statistic_by_global_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `guid` varchar(50) COMMENT '文件ID',
...
CREATE TABLE if not exists boss.dws_file_7d_statistic_by_member_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `user_id` varchar(50) COMMENT '成员ID',
...
CREATE TABLE if not exists boss.dws_space_1d_updated_statistic_by_global_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `guid` varchar(50) COMMENT '文件ID',
...
create view if not exists boss.dws_enterprise_7d_active_user_statistic_by_global_daily_view as select
    ldate,
    team_id,
    user_id,
...
create view if not exists boss.dws_enterprise_30d_active_user_statistic_by_global_daily_view as select
  ldate,
  team_id,
  user_id,
  (file_views * 1 + create_files * 10 + (add_collaborations + public_shares + comments + use_ats) * 5)  as active_score
from boss.dws_collaboration_30d_statistic_by_member_daily ;
...
create view if not exists boss.dws_enterprise_td_save_time_statistic_by_global_daily_view as select
   ldate,
   team_id,
...
create view if not exists boss.dws_enterprise_td_auto_saves_statistic_by_global_daily_view as select
    ldate,
    team_id,
...
CREATE TABLE if not exists boss.dws_creation_1d_download_by_global_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50) COMMENT '企业ID',
    `create_objs` int(6) COMMENT '新建总文件数',
...
CREATE TABLE if not exists boss.dws_usage_1d_download_by_member_daily
(
    `ldate` Date COMMENT '日期：最近7天最后一天',
    `team_id` varchar(50)  COMMENT '企业ID',
    `department_id` varchar(50) COMMENT '部门ID',
