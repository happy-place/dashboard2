...
-- 4) 查询
select * from shard.dws_file_7d_product_statistic_by_department_daily where ldate = '2020-11-26';
select * from all.dws_file_7d_product_statistic_by_department_daily where ldate = '2020-11-26';
